...
export const content = {
  ...
  stats: {
    ...
    items: [
      { value: "9", en: "Open repositories", zh: "开源仓库" },
  ...
  projects: {
    ...
    items: [
      {
        name: "mcos",
        en: { d: "A Mobile Command Bus for Android — a typed command protocol, on-device runtime, plugin SDK, and an optional AI planner that compiles natural language into an auditable DSL instead of opaque side effects." },
        zh: { d: "面向 Android 的移动命令总线 —— 类型化命令协议、设备端运行时、插件 SDK 与可选 AI 规划器,将自然语言编译为可审计的 DSL,而非不透明的副作用。" },
        tech: ["Kotlin", "Android", "Gradle"],
        lang: "Kotlin",
        stars: 0,
        url: "https://github.com/Morainet/mcos",
      },
      {
        name: "Parsy",
        en: { d: "A modern, high-performance, local-first JSON developer toolkit — format, validate, and minify JSON instantly, entirely in your browser. Your data never leaves your device." },
        zh: { d: "现代化、高性能、本地优先的 JSON 开发者工具包 —— 格式化、校验、压缩全部在浏览器内即时完成。数据永不离开设备。" },
        tech: ["Next.js", "TypeScript", "Monaco"],
        lang: "TypeScript",
        stars: 0,
        url: "https://github.com/Morainet/Parsy",
      },
      {
        name: "morainet-ai",
  ...
  journey: {
    ...
    milestones: [
      ...
      {
        year: "2026.08",
        en: { t: "Tools for everyday work", d: "mcos turns every collaborative phone capability into an AI-callable command, and Parsy ships a local-first JSON toolkit that keeps your data on-device." },
        zh: { t: "面向日常的工具", d: "mcos 将手机上每一项可协作能力变为 AI 可安全调用的命令,Parsy 上线本地优先的 JSON 工具集,让数据始终留在设备端。" },
      },
      {
        year: "Next",
